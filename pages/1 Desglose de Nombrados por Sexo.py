...
# Set Page Header
st.header("Desglosadose por sexo de nombrados/as en ADP")
...
# colores y orden de sexo
Sexo_Orden=['Mujer','Hombre']
Sexo_Color = {'Hombre': '#ffa800', 'Mujer': '#8430ce'}  # Mapeo de colores por sexo
